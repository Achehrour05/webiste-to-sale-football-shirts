...
function France() {
  ...
  const product = [
    { id: 1, img: require("../assets/paris.jpg"), text: "Paris Saint Germain", price: "800 DH" },
    { id: 2, img: require("../assets/monaco.jpg"), text: "Monaco", price: "800 DH" },
    { id: 3, img: require("../assets/marseille.jpg"), text: "Marseille", price: "800 DH" },
    { id: 4, img: require("../assets/lion.jpg"), text: "Olympic Lion", price: "800 DH" },
    { id: 5, img: require("../assets/lile.jpg"), text: "Lile", price: "800 DH" },
  ];
