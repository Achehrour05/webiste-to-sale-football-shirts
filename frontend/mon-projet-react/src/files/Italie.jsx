...
function Italie() {
  ...
  const product = [
    { id: 1, img: require("../assets/juventus.jpg"), text: "Juventus", price: "800 DH" },
    { id: 2, img: require("../assets/milan.jpg"), text: "AC Milan", price: "800 DH" },
    { id: 3, img: require("../assets/inter.jpg"), text: "Inter Milan", price: "800 DH" },
    { id: 4, img: require("../assets/atalanta.jpg"), text: "Atalanta", price: "800 DH" },
    { id: 5, img: require("../assets/napoli.jpg"), text: "Napoli", price: "800 DH" },
  ];
