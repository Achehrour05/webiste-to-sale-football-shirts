...
import Ads from "../ads/Adsss.jsx";
import "./Middle.css";
import { useNavigate } from 'react-router-dom';
import { FaAngleRight, FaChevronLeft } from "react-icons/fa6";
import { fetchAndFormatProducts } from '../../utils/fetchProducts.js';
import CarouselAvance from '../ui/Carousel/CarouselAvance.jsx';
...
export default function HorizontalScroll() {
  ...
  useEffect(() => {
    fetchAndFormatProducts("http://localhost:3000/api/products/all?limit=15")
      .then(setProducts);
  }, []);
